...
C
      ...
      PARAMETER(LINMAX=1000,TXTMAX=9650*5+1,BINFIL='./advent.bin')
C
...
23458 WRITE(*,*)'ERROR: Unable to read advent.bin'
      STOP
...
45684 WRITE(*,*)'ERROR: Failed to write to the save file'
      CLOSE(UNIT=2)
      GOTO 45686
...
56794 WRITE(*,*)'ERROR: Failed to read from the save file'
      CLOSE(UNIT=2)
      GOTO 2010
